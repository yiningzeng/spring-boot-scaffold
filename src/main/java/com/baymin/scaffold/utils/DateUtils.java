...
public class DateUtils {
    ...
    public static String getCurrentDateTime(){
        ...
        return sf.format(Calendar.getInstance().getTimeInMillis());
    }
    ...
    public static Date englishToDate(String dateStr){
    ...
    public static void main(String args[]){
        Date date = new Date();
        System.out.println(DateUtils.getDayBegin().toString());
        System.out.println(DateUtils.getDayEnd().toString());
